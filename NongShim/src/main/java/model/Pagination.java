...
public class Pagination {
	...
	public int getTotalPageGroup() {
		...
		if(getTotalPage()%this.pageCountPerPageGroup!=0) //나눈값의 나머지가 0이 아니면,,나머지가 있으면 
			totalPageGroup+=1;
		return totalPageGroup;
	}
	/**
	...
	public int getEndPageOfPageGroup() {
		...
		if(endPage>this.getTotalPage()) // 곱한 값(현재 9페이지라면 3group이므로 곱한값이 12)이 총페이수(10page)보다 크면 
