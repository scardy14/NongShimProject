...
<form action="${pageContext.request.contextPath}/RegisterController.do" method="post" onsubmit="register(event)" onsubmit="checkRegisterForm(event)">
	<input type = "text" name = "id" id="memberId" required="required" placeholder="아이디" onkeyup="checkId()" style="height: 40px;" >
	...
	<input type = "text" name = "tel" id="memberTel" required="required" placeholder="전화번호" onkeyup="checkTel()" style="height: 40px;">
	<span id="checkResult2"></span><br>
	<input type = "text" name = "accountNo" required="required" placeholder="계좌번호" style="height: 40px;"><br>
	<input type="checkbox" value="약관동의"><br>
	<button type = "submit" style="width: 190px;   background-color: #00ac00; color: white;">회원가입</button>
</form>
