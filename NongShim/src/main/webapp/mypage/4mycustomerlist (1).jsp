		...
		<nav id="sidebarMenu"
			...
			<div class="position-sticky float:left">
				<div class="list-group list-group-flush mx-3 mt-4">
					...
					</a> <a href="MyPagecustomerController.do" class="list-group-item list-group-item-action py-2 ripple active">
					...
					<a href="MyPageSellerCheckMoveController.do" class="list-group-item list-group-item-action py-2 ripple">
						<i class="fas fa-chart-area fa-fw me-3"></i><span>판매자인증</span>				
